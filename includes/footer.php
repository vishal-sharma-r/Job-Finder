...
<div class="container">
  ...
  <div class="row text-center">
    <div class="col-12">
      ...
      Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Vishal Sharma ❤</a>
      <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small></p>
      <!-- <a href = "http://localhost/jobfinder/auth/logout.php">Logout</a> -->
    </div>
  </div>
</div>
</footer>
